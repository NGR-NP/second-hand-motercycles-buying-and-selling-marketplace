    ...
    <section className={styles.sec}>
      <div className={styles.cont}>
        <div className={styles.content}>
          ...
          <div >
            <a href="http://localhost:8000/auth/google"><button className="text-white border p-4  flex w-[25rem] duration-300 active:scale-95 hover:scale-105 pl-20"> <span style={{ width: 50 }}><FcGoogle size={28} /></span>  Continue with Google</button></a>
          </div>
