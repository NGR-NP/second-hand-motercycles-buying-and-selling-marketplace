...
const AdminAsideSec = () => {
  return (
    <aside className="block overflow-y-auto fixed inset-y-0 flex-wrap justify-between items-center p-0 my-4 ml-4 w-auto antialiased bg-white rounded-2xl border-0 shadow-none transition-transform duration-200 -translate-x-full max-w-62 ease z-990 xl:left-0 xl:translate-x-0 xl:bg-transparent">
      <div className="h-19.5">
        ...
        >
          <Image
            ...
            className="inline w-8 max-w-full h-full max-h-8 rounded-full transition-all duration-200 ease-nav-brand"
            alt="main_logo"
          />
      ...
      <hr className="mt-0 h-px bg-transparent bg-gradient-to-r from-transparent to-transparent via-black/40" />

      <div className="block overflow-auto items-center w-auto max-h-screen grow basis-full">
        <ul className="flex flex-col pl-0 mb-0">
          <li className="mt-0.5 w-full">
            <Link
              ...
              href="/dashboard"
            >
              <div className="bg-gradient-to-tl from-black1 to-white2 shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                <svg
                  width="12px"
                  height="12px"
                  viewBox="0 0 45 40"
              ...
              <span className="ml-1 opacity-100 duration-300 pointer-events-none ease-soft">
                Dashboard
              </span>
            </Link>
          </li>
                    ...
                    >
                      <g transform="translate(1716.000000, 291.000000)">
                        <g transform="translate(153.000000, 2.000000)">
                          <path
                            className="opacity-60 fill-slate-800"
